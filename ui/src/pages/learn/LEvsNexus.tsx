...
const pillarGroups: PillarGroup[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { le: 'payment_method', nexus: 'transactions[].metadata.payment_method', notes: 'Balances pillar = UPPERCASE (e.g. VISA, MASTERCARD); normalise to uppercase in Nexus output' },
  ...
  },
  {
    ...
    entries: [
      ...
      { le: 'payment_method', nexus: 'transactions[].metadata.payment_method', notes: 'COS pillar = lowercase (e.g. visa, mastercard); normalise to uppercase in Nexus output' },
